...
export class Authenticator<User = unknown> {
  ...
  public readonly sessionStrategyKey: NonNullable<
    AuthenticateOptions["sessionStrategyKey"] // TODO, all three are AuthenticatorOptions, except sessionStrategyKey
  >;
  public readonly throwOnError: NonNullable<
    AuthenticatorOptions["throwOnError"]
  >;

  /**
   * Create a new instance of the Authenticator.
   *
   * If receives a instance of SessionStorage. This session storage could
  ...
  /**
   * Call this method with the Strategy, the optional name allows you you setup
   ...
   * of the strategy you want to use and request to authenticate.
   * @example
